...
#define lmt_sw7_Pin GPIO_PIN_4
#define lmt_sw7_GPIO_Port GPIOC
#define lmt_sw8_Pin GPIO_PIN_5
#define lmt_sw8_GPIO_Port GPIOC
#define ENC3_A_Pin GPIO_PIN_2
#define ENC3_A_GPIO_Port GPIOB
#define lmt_sw1_Pin GPIO_PIN_11
#define lmt_sw1_GPIO_Port GPIOB
#define lmt_sw2_Pin GPIO_PIN_13
#define lmt_sw2_GPIO_Port GPIOB
#define lmt_sw3_Pin GPIO_PIN_14
